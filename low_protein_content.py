...
model.reactions.get_by_id("EX_cpd00020_e0_b").upper_bound = 1.5
model.reactions.get_by_id("EX_cpd00020_e0_b").lower_bound = 1.5
...
total_protein_cost_constraint = model.problem.Constraint(total_protein_cost_expression, lb=10.3, ub=10.3)
...
output_filename = "lowest_protein_flux_distribution_2.xlsx"
